...
## 🌐 GitHub Pages Deployment (Zero Node.js Required)

This repository is built with **pure static HTML5, CSS3, and Vanilla JavaScript** located directly at the root (`index.html`). **Node.js is NOT required** to run, host, or view this project.

### How to Enable GitHub Pages:
1. Navigate to your repository on GitHub: [faxingberling1/Rocky-TheRockefellerChristmasTree](https://github.com/faxingberling1/Rocky-TheRockefellerChristmasTree).
...
4. Under **Build and deployment**:
   ...
   - Click **Save**.
5. *(Optional for Custom Subdomain)*: Under **Custom domain**, enter your subdomain (e.g., `sow.neogentechnologies.com`) and configure the CNAME record with your DNS provider.

Your site will automatically publish at:  
`https://faxingberling1.github.io/Rocky-TheRockefellerChristmasTree/` (or your custom subdomain).

---

## 💻 Local Viewing (Offline / No Server Required)

You can open the proposal locally on any computer without installing Node.js or running a terminal:
- Simply double-click `index.html` to open it in Chrome, Edge, Safari, or Firefox.

*(Optional)* If you prefer running with Node.js / Express locally:
```bash
npm install
node server.js
...
- **Frontend:** Vanilla HTML5, Modern CSS3 (Glassmorphism, CSS Grid, Responsive Design), Vanilla JavaScript (ES6+)
- **Hosting:** 100% Static Web Server, GitHub Pages, Custom Subdomains, or CDN
- **Typography:** Google Fonts (`Outfit`, `Cinzel`, `Inter`)
- **Assets:** High-resolution Rockefeller Center Christmas Tree background, extracted book cover typography, and character artwork.
- **Optional Backend:** Node.js + Express 5 (`server.js`)
